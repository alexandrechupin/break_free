class IncidentsController < ApplicationController
  ...
  def incident_params
    params.require(:incident).permit(:tribunal, :user, :description, :date, :recurrent, :author_is_victim, :address, :publication_agreement, :place_type, :incident_category, :description_after_feeling, :description_about_testimony, :witness, :offender)
  end
